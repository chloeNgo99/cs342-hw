...
template<class T>
ListNode<T> *LinkedList<T>::_reverse_recursive(ListNode<T> *ptr, ListNode<T> *newHead) {
    /*
     * TODO: homework
     * Optional.
    ...
    ptr = next;
// Recursive call
    return _reverse_recursive(ptr, newHead);
...
void LinkedList<T>::reverse_recursive() {
     ...
     * TODO: homework
     */
    head->next = _reverse_recursive(head->next, NULL);
}