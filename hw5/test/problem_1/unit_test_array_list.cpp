...
TEST(problem1, arraylist_equal) {
    test_equal_int<ArrayList<int>>();
    test_equal_string<ArrayList<std::string>>();
}

TEST(problem1, push_back_arraylist_over_limit) {
...
TEST(problem1, push_front_arraylist_over_limit) {
    const int CAPACITY = 5;
...
TEST(problem1, array_list_subscriptor) {
    test_subscriptor_access<ArrayList<int>>();
}

TEST(problem1, array_list_reverse) {
