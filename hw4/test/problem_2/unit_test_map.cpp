...
TEST(problem_2, array_map_init_is_empty) {
    ArrayMap<int, int> hash_map;
    ASSERT_TRUE(hash_map.is_empty());
}

TEST(problem_2, array_map_put_new_key) {
...
TEST(problem_2, array_map_remove) {
 ...
 */
TEST(problem_2, array_map_list_contructor) {
...
TEST(problem_2, array_map_list_contructor_2) {
...
TEST(problem_2, array_map_equal) {
...
TEST(problem_2, array_map_copy_constructor) {
...
TEST(problem_2, array_map_copy_constructor_duplicate_hash_key) {
...
TEST(problem_2, array_map_keyset) {
